...
安装rest_framework.authtoken应用，并配置 REST_FRAMEWORK 项
...
在Django的前后端分离项目中DRF(Django Restframe Work)框架无疑是首选，关于token验证一般使用的是JWT，但是JWT只支持到 Django1.x 的版本。

官方推荐 Django2.x 之后的版本使用 simple JWT，官方文档。
