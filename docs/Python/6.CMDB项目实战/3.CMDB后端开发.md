...
2.项目中启用swagger: `devops_api/devops_api/settings.py`
...
3.配置路由: `devops_api/devops_api/urls.py`
...
![1707214750456](https://cdn.jsdelivr.net/gh/hujianli94/picx-images-hosting@master/1707214750456.webp){: .zoom}
