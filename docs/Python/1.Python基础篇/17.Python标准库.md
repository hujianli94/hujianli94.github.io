...
"""
python .\crudini-001.py set Database MaxConnections 100 example.ini
python .\crudini-001.py get Database Host example.ini
python .\crudini-001.py update Server Port 9090 example.ini
python .\crudini-001.py del Server port example.ini
python .\crudini-001.py del Server port ip example.ini
python .\crudini-001.py merge example2.ini example.ini
"""
...
def main():
    parser = argparse.ArgumentParser(description='INI/CONF file manipulation tool')
    parser.add_argument('--section', help='Section name')
    parser.add_argument('--param', help='Parameter name')
    parser.add_argument('--value', help='Value to set/update')
    parser.add_argument('--list', nargs='+', help='List of values to delete')
    parser.add_argument('--merge_file', help='File to merge with base configuration')
...
```sh
# Set操作：
python crudini.py example.ini set Database MaxConnections 100

# Get操作：
python crudini.py example.ini get Database Host

# Update操作：
python crudini.py example.ini update Server Port 9090

# Delete操作：
python crudini.py example.ini del Server Port IP

# Merge操作：
python crudini.py example.ini merge example2.ini
```
