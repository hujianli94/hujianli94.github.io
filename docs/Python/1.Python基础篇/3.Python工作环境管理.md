...
# 选项 -p python3，表示 Python 有两个版本 python2 和 python3，指定虚拟环境中的 python 版本为 python3；
# 选项 --no-site-packages，表示不安装任何所第三方包，得到了一个不带任何第三方包的 “纯净” 的 Python 运行环境。
