...
```python
# -*- coding:utf8 -*-
# Copyright: (c)  : @Time ${DATE} ${HOUR}:${MINUTE}  @Author  : hjl
# @Author  : ${USER}
# @File    : ${NAME}.py
...
!!! info "python 相关"
    ...
    - Chinese Languate Pack：简体中文包
    - Python Debugger：Python调试插件
    - autopep8：自动格式化为PEP8规范格式
    - Pip Manager: 安装包管理
...
```json
{
  ...
  "editor.defaultFormatter": "esbenp.prettier-vscode", // 设置默认代码格式化工具为Prettier。
  "editor.wordWrap": "on", // 启用自动换行
  "editor.fontSize": 16, // 编辑器中的字体
  "editor.rulers": [80, 100], // 设置编辑器标尺
  ...
  "[python]": {
    ...
    "editor.rulers": [80, 100], // 显示80和100字符的参考线
    "editor.renderWhitespace": "all", // 显示所有空白字符
    "editor.wordWrap": "off", // 关闭单词换行
    // "editor.defaultFormatter": "ms-python.python",
    "editor.defaultFormatter": "ms-python.black-formatter", //Black Formatter插件 pip install black
    "editor.formatOnSave": true, // 在保存时自动格式化代码
    "editor.formatOnType": true
  },
  "python.formatting.blackArgs": ["--line-length 120"],
  "editor.defaultFormatter": "esbenp.prettier-vscode", //Download the Prettier Formatter eg: ext install esbenp.prettier-vscode
  ...
  "python.linting.pylintEnabled": true, // 启用Pylint进行代码检查
  "python.linting.enabled": true, // 启用Python代码检查
  "python.languageServer": "Pylance",
  "python.jediEnabled": true,
  "python.autoComplete.addBrackets": true,
  "python.formatting.blackArgs": ["--line-length", "88"], // 传递给Black格式化工具的参数，这里设置最大行长度为88。
...
vscode 实现远程 linux 服务器上 Python 开发

- <https://www.cnblogs.com/chenhuabin/p/13946762.html>

## 7. vim 配置 Python 开发环境
