...
gosible 是用 Go 编写的高性能、高并发性的 ssh 工具。

它可以有效地管理成千上万的 Linux 服务器集群。它的速度是 ansible 的十倍。如果您需要更多的性能和更好的易用性，您将喜欢 gosible

gosible, like ansible

- https://github.com/serialt/gosible
...
A tool for create a SSH tunnel.

- https://github.com/atompi/culvert.git
