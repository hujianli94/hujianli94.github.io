...
zap 是 uber 开源的一款高性能日志库，其性能比标准库 log 快 10 倍左右，比其他日志库快 10 倍左右。

- http://v5blog.cn/pages/17151b/


## 6.logrus日志包

logrus 是一个结构化的日志库，同时支持日志级别、Hook、Formatter、Logger 实例、输出目的地等功能。

- http://v5blog.cn/pages/3e6a77/


## 7.参考文献

- http://v5blog.cn/pages/b641d5/
