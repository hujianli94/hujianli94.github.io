...
class TestEndpoint(object):
    def docker_images(self, ctx, arg):
...
if __name__ == '__main__':
    ...
    fun = client.call(ctx.to_dict(), method='docker_images', arg='hello')
    LOG.info(f"Received response: {fun}")
    print(fun)
```
...
```sh
(openstack-python3.8.6) $ python rpc_server.py
2025-03-20 22:41:46.579 7578 INFO __main__ [-] Starting server...
2025-03-20 22:41:49.668 7578 INFO __main__ [-] Received request in docker_images method with context: None, arg: hello
^C2025-03-20 22:42:55.449 7578 INFO __main__ [-] Stopping server...



(openstack-python3.8.6) $ python rpc_client.py
2025-03-20 22:41:49.650 7625 WARNING oslo_messaging.rpc.client [-] Using RPCClient manually to instantiate client. Please use get_rpc_client to obtain an RPC cli                  ent instance.
2025-03-20 22:41:49.650 7625 INFO __main__ [None req-ff787c3d-1b44-42ac-9047-8dccdf334154 - - - - - -] Sending request to server with context: <oslo_context.cont                  ext.RequestContext object at 0x7f2fcdf75a30>
2025-03-20 22:41:50.168 7625 INFO __main__ [None req-ff787c3d-1b44-42ac-9047-8dccdf334154 - - - - - -] Received response: nginx:1.26.3
ubuntu:20.04
