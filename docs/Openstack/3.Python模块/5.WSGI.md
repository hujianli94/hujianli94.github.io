...
if __name__ == '__main__':
    ...
    serve(app_factory({}, **{}), host='localhost', port=8000)
```
...
###获取一条虚拟机记录的信息
curl -X GET http://localhost:8000/instances/30c7ac8f-ebb5-41c1-8fd8-d84dadccf3d0


###更新一条虚拟机记录的信息
curl -X PUT -H "Content-Type: application/json" -d '{"name":"updated"}' http://localhost:8000/instances/30c7ac8f-ebb5-41c1-8fd8-d84dadccf3d0


###删除一条虚拟机记录
curl -X DELETE http://localhost:8000/instances/30c7ac8f-ebb5-41c1-8fd8-d84dadccf3d0
```
