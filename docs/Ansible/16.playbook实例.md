...
## vscode 写 ansible 代码片段

```yml
{
	// Place your ansible-1.1 工作区 snippets here. Each snippet is defined under a snippet name and has a scope, prefix, body and
	...
	// }
  "ansible-group_vars_all_yml": {
    "prefix": "ansible_group_vars_all_snippet1",
    "body": [
      ...
      "",
      "# ceph-ansible会根据网卡参数获取相应的IP地址",
      "monitor_interface: ens33",
      "radosgw_interface: ens33",
      "# 指定不配置防火墙，否则防火墙每次都会被打开",
    ...
    "description": "ansible-group_vars_all.yml"
  },
  "ansible-host_snippet1": {
    "prefix": "ansible_host_snippet1",
    "body": [
      "- hosts: mons",
      "  gather_facts: false",
      "  become: True",
    ...
    "description": "ansible-host_snippet1"
  },
  "ansible-host_snippet2": {
    "prefix": "ansible_host_snippet2",
    "body": [
      "---",
      "- hosts: mons",
      "  gather_facts: false",
    ...
    "description": "ansible-host_snippet2"
  },
  "ansible-command": {
    "prefix": "ansible_command_snippet1",
    "body": [
      "---",
    ...
    "description": "ansible-command1"
  },
  "ansible-command_snippet2": {
    "prefix": "ansible_command_snippet2",
    "body": [
      "- name: generate cluster fsid",
    ...
    "description": "ansible-command_snippet2"
  },
  "ansible-command_snippet3": {
    "prefix": "ansible_command_snippet3",
    "body": [
    ...
    "description": "ansible-command_snippet3"
  },
  "ansible-shell_snippet1": {
    "prefix": "ansible_shell_snippet1",
    "body": [
    ...
    "description": "ansible-shell1"
  },
  "ansible-set_fact1": {
    "prefix": "ansible_set_fact_snippet1",
    "body": [
      "- name: set_fact fsid",
      "  set_fact:",
      "     fsid: \"{{ cluster_uuid.stdout }}\""
    ],
    "description": "ansible-set_fact1"
  },
  "ansible-set_fact2": {
    "prefix": "ansible_set_fact_snippet2",
    "body": [
      "- name: set_fact monitor_ipv4",
      "  set_fact:",
      "    monitor_ipv4: \"{{ shell_out.stdout }}\""
    ],
    "description": "ansible-set_fact2"
  },
  "ansible-set_fact_snippet3": {
    "prefix": "ansible_set_fact_snippet3",
    "body": [
    ...
    "description": "ansible-set_fact_snippet3"
  },
  "ansible-set_fact_snippet4": {
    "prefix": "ansible_set_fact_snippet4",
    "body": [
    ...
    "description": "ansible-set_fact_snippet4"
  },
  "ansible-set_fact_snippet5": {
    "prefix": "ansible_set_fact_snippet5",
    "body": [
    ...
    "description": "ansible-set_fact_snippet5"
  },
  "ansible-when_snippet1": {
    "prefix": "ansible_when_snippet1",
    "body": [
    ...
    "description": "ansible-when_snippet1"
  },
  "ansible-when_snippet2": {
    "prefix": "ansible_when_snippet2",
    "body": [
    ...
    "description": "ansible-when_snippet2"
  },
  "ansible-when_snippet3": {
    "prefix": "ansible_when_snippet3",
    "body": [
    ...
    "description": "ansible-when_snippet3"
  },
  "ansible-when_snippet4": {
    "prefix": "ansible_when_snippet4",
    "body": [
    ...
    "description": "ansible-when_snippet4"
  },
  "ansible-debug_snippet1": {
    "prefix": "ansible_debug_snippet1",
    "body": [
      "",
      "- name: \"show ceph status for cluster {{ cluster }}\"",
      "  debug:",
    ...
    "description": "ansible-debug_snippet1"
  },
  "ansible-copy_snippet1": {
    "prefix": "ansible_copy_snippet1",
    "body": [
    ...
    "description": "ansible-copy_snippet1"
  },
  "ansible-package_snippet1": {
    "prefix": "ansible_package_snippet1",
    "body": [
    ...
    "description": "ansible-package_snippet1"
  },
  "ansible-package_snippet2": {
    "prefix": "ansible_package_snippet2",
    "body": [
    ...
    "description": "ansible-package_snippet2"
  },
  "ansible-yum_snippet1": {
    "prefix": "ansible_yum_snippet1",
    "body": [
    ...
    "description": "ansible-yum_snippet1"
  },
  "ansible-yum_snippet2": {
    "prefix": "ansible_yum_snippet2",
    "body": [
    ...
    "description": "ansible-yum_snippet2"
  },
  "ansible-file_snippet1": {
    "prefix": "ansible_file_snippet1",
    "body": [
      "# 创建Ceph配置目录",
    ...
    "description": "ansible-file_snippet1"
  },
  "ansible-file_snippet2": {
    "prefix": "ansible_file_snippet2",
    "body": [
    ...
    "description": "ansible_file_snippet2"
  },
  "ansible-file_snippet3": {
    "prefix": "ansible_file_snippet3",
    "body": [
    ...
    "description": "ansible-file_snippet3"
  },
  "ansible-systemd_snippet1": {
    "prefix": "ansible_systemd_snippet1",
    "body": [
    ...
    "description": "ansible-systemd_snippet1"
  }
}
```
