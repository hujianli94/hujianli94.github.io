...
![](../../assets/static/kubernetes/2/6-1-selector.png)
...
![](../../assets/static/kubernetes/2/6-2-selector.png)
...
!!! warning "注意"
    ...
    Endpoint IP 地 址 不 能 是 loopback(127.0.0.0/8)、 link-loca(l169.254.0.0/16)或者link-local多播地址(224.0.0.0/24)。
...
![](../../assets/static/kubernetes/2/6-3-ingress.png)
