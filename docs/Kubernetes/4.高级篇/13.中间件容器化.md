...
传统架构管理中间件
![](../../assets/static/kubernetes/5/chuantong-01.png)
...
![](../../assets/static/kubernetes/5/k8s-managezhongjj.png)
...
本小节演示的Operator是由UCloud开源的一个项目，项目地址为https://github.com/ucloud/redis-cluster-operator，打开此链接可以看
到详细的操作文档，如图

Redis Operator目录
![](../../assets/static/kubernetes/5/k8s-operator.png)
