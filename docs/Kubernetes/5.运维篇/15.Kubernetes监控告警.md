...
![](../../assets/static/image-20230201162610322.png)
...
![](../../assets/static/image-20230201162647601.png)
...
待容器全部下载完成（首次安装镜像下载可能会很慢）并且启动后，可以访 问 Grafana 和 Prometheus 。

在 执 行 安 装 时 会 自 动 创 建 Grafana 和Prometheus的Service，可以通过NodePort或者Ingress的方式访问，在此演
示的为NodePort方式。首先将Grafana的Service改成NodePort类型：
...
![](../../assets/static/image-20230201162804958.png)
...
![](../../assets/static/image-20230201162834119.png)
...
![](../../assets/static/image-20230201162929442.png)
...
![](../../assets/static/image-20230201163027992.png)
...
![](../../assets/static/image-20230201163104218.png)



同时在Alerts页面也能看到Controller Manager和Scheduler的告警，如图15.8所示。

![](../../assets/static/image-20230201163132965.png)
...
![](../../assets/static/image-20230201163251003.png)

图15.10　查看Targets

![](../../assets/static/image-20230201163321876.png)
...
![](../../assets/static/image-20230201163409230.png)
...
![](../../assets/static/image-20230201163437342.png)
...
![](../../assets/static/image-20230201163511782.png)
...
![](../../assets/static/image-20230201163607458.png)

导 入 Grafana  Dashboard ， 地址为https://grafana.com/grafana/dashboards/6239，导入步骤和之前类似，在此不再演示。

导入完成后，即可在Grafana看到监控数据，如图15.18所示。

![](../../assets/static/image-20230201163635173.png)
...
![](../../assets/static/image-20230201163708525.png)

图15.20　查看黑盒监控Target

监控状态为UP后, 导入黑盒监控的模板（https://grafana.com/grafana/dashboards/13659）即可,如图15.21所示。

![](../../assets/static/image-20230201163734830.png)
...
![](../../assets/static/image-20230201163819369.png)
...
![](../../assets/static/image-20230201163853149.png)
...
![](../../assets/static/image-20230201163927032.png)
...
![](../..//assets/static/image-20230201165949354.png)
...
前面学?了云原生应用、非云原生应用、黑盒监控和集群外部主机监控，同时学习了ServiceMonitor和静态配置的使用，掌握这些以后，生产环境的大部分场景都可以进行监控。

但是监控并不是最终的目的，虽然通过Grafana的Dashboard能看到一些监控大屏，但是需要监控的地方太多，并且技术人员不可能随时随地都盯着Dashboard，所以需要对严重的告警进行通知。

接下来就需要用到Prometheus的另一个组件—Alertmanager，主要用来进行告警的通知，可以采用邮
箱、钉钉、微信、Slack、Webhook等进行通知。
...
![](../../assets/static/image-20230201170020998.png)
...
![](../../assets/static/image-20230201170114679.png)
...
![](../../assets/static/image-20230201170335822.png)
...
![](../..//assets/static/image-20230201170619412.png)
...
![](../../assets/static/image-20230201170651465.png)
...
![](../../assets/static/image-20230201170727375.png)
...
![](../../assets/static/image-20230201170824611.png)
...
![](../../assets/static/image-20230201170905382.png)
...
![](../../assets/static/image-20230201170946805.png)
...
![](../../assets/static/image-20230201171032834.png)
...
![](../../assets/static/image-20230201171112760.png)
...
![](../../assets/static/image-20230201171211465.png)
...
![](../../assets/static/image-20230201171245936.png)
...
![](../../assets/static/image-20230201171342290.png)
...
![](../../assets/static/image-20230201171416057.png)
...
![](../../assets/static/image-20230201171707785.png)

图15.45　查看告警

![](../../assets/static/image-20230201171738974.png)

图15.46　查看告警语法

之后单击expr的语法，可以进入查询页面，如图15.47所示。

![](../../assets/static/image-20230201171819384.png)
...
![](../../assets/static/image-20230201171900132.png)
...
![](../../assets/static/image-20230201172020191.png)
...
![](../../assets/static/image-20230201172048753.png)

图15.51　查看企业ID



![](../../assets/static/image-20230201172119267.png)

图15.52　添加子部门

输入Prom告警，之后单击“确定”按钮，如图15.53所示。

![](../../assets/static/image-20230201172158429.png)
...
![](../../assets/static/image-20230201172231264.png)

图15.54　添加成员

查看该部门ID（对应Alertmanager的to_party字段）并记录，如图15.55所示。

![](../../assets/static/image-20230201172307236.png)
...
![](../../assets/static/image-20230201172519103.png)
...
![](../../assets/static/image-20230201172557234.png)
...
![](../../assets/static/image-20230201172953194.png)
...
![](../../assets/static/image-20230201173048119.png)



图15.59　查看AgentId和Secret

![](../../assets/static/image-20230201173113299.png)
...
此处配置的receiver名字为wechat-ops，可根据实际情况划分不同的部门。此时配置的to_user为@all，代表发送给所有人，也可以只发送给部门的某一个人，只需要将此处改为USER_ID即可，如图15.61所示。

![](../../assets/static/image-20230201173143540.png)
...
![](../../assets/static/image-20230201173213204.png)
...
![](../../assets/static/image-20230201173244915.png)
...
因此本书还是以传统的配置文件进行讲解，有兴趣的读者可以参考 https://github.com/prometheus-operator/prometheus-operator/blob/master/Documentation/design.md#alertmanagerconfig 进行学习。
