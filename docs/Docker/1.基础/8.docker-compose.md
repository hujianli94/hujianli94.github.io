...
=== "docker 命令"
    ...
    -e RABBITMQ_DEFAULT_USER=admin -e RABBITMQ_DEFAULT_PASS=admin --hostname myRabbit -it rabbitmq:management
    ```
...
## 7.常用的 docker-compose

基于 docker-compose 编排服务环境，减少繁琐步骤，快速启动容器，提高运维效率。

- https://gitee.com/su-bushi/docker-compose

存放各种 docker image 构建脚本或者快速启动的 docker-compose 文件

- https://gitee.com/hujianli94net/docker
